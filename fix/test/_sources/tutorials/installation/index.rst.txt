...
pji is currently hosted on PyPI. It required python >= 3.6.

You can simply install pji from PyPI with the following command:
...
.. code:: shell
    ...
    pip install -U git+https://github.com/hansbug/pji.git@main
